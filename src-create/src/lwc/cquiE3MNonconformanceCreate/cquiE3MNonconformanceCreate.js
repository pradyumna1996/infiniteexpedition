...
import FIELD_COMPLIANCEQUEST__SQX_CONTROLLED_DOCUMENT__C from '@salesforce/schema/compliancequest__SQX_Nonconformance__c.compliancequest__SQX_Controlled_Document__c';

import FIELD_COMPLIANCEQUEST__SQX_EQUIPMENT__C from '@salesforce/schema/compliancequest__SQX_Nonconformance__c.compliancequest__SQX_Equipment__c';
...
import FIELD_COMPLIANCEQUEST__SQX_CONTROLLED_DOCUMENT__NAME from '@salesforce/schema/compliancequest__SQX_Nonconformance__c.compliancequest__SQX_Controlled_Document__r.Name';
    


    
import FIELD_COMPLIANCEQUEST__SQX_EQUIPMENT__NAME from '@salesforce/schema/compliancequest__SQX_Nonconformance__c.compliancequest__SQX_Equipment__r.Name';
...
import CQE3M_DETAILS from '@salesforce/label/c.CQE3M_DETAILS';
        
    
        
import CQE3M_IMPACTED_PARTLOT from '@salesforce/label/c.CQE3M_IMPACTED_PARTLOT';
        
    
        
import CQE3M_REFERENCES from '@salesforce/label/c.CQE3M_REFERENCES';
...
export default class cquiE3MNonconformanceCreate  extends cqRecordForm {
    ...
    get CQE3M_DETAILS() {
        return CQE3M_DETAILS;
    }
        
    
        
    get CQE3M_IMPACTED_PARTLOT() {
        return CQE3M_IMPACTED_PARTLOT;
    }
        
    
        
    get CQE3M_REFERENCES() {
        return CQE3M_REFERENCES;
    }
